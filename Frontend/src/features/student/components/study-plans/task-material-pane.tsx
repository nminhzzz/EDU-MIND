...
export function TaskMaterialPane({ task }: TaskMaterialPaneProps) {
  return (
    <div className="space-y-5 text-left">
      <div className="bg-zinc-50/50 dark:bg-zinc-950/20 border border-zinc-200/50 dark:border-zinc-850 p-4 rounded-md">
      ...
      {task.rag_content ? (
        <div className="bg-indigo-50/15 dark:bg-indigo-950/10 border border-indigo-100 dark:border-indigo-900/60 p-4 rounded-md space-y-2.5 shadow-sm">
        ...
        <div className="bg-zinc-50/50 dark:bg-zinc-950/10 border border-zinc-200/50 dark:border-zinc-800 p-4 rounded-md space-y-2 text-center">
      ...
      <div className="border border-zinc-200/80 dark:border-zinc-800 rounded-md p-4 space-y-3 bg-white dark:bg-zinc-900/50">
