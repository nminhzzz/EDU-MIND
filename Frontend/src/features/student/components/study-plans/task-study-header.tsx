  ...
  return (
    <div className="p-5 border-b border-zinc-150 dark:border-zinc-800 flex justify-between items-center bg-zinc-50/50 dark:bg-zinc-900/10 gap-4">
      ...
      {backHref ? (
        <Link
          href={backHref}
          className="inline-flex items-center gap-1.5 shrink-0 px-3 py-2 rounded-md border border-zinc-200 dark:border-zinc-700 text-xs font-bold text-zinc-600 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
        >
        ...
        onClose && (
          <button
            type="button"
            onClick={onClose}
            className="p-2 rounded-md text-zinc-400 hover:text-zinc-600 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors cursor-pointer shrink-0"
          >
