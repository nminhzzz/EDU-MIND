      ...
      <AnimatePresence>
        ...
        {!isOpen && (
          ...
          >
            ...
            {totalUnread > 0 && (
              <span className="absolute -top-1 -right-1 min-w-[20px] h-5 px-1 bg-red-500 border-2 border-white dark:border-zinc-900 rounded-md text-[10px] font-black text-white flex items-center justify-center shadow-md shadow-red-500/40 animate-bounce">
