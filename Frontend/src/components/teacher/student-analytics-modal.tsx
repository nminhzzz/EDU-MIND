    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-md shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden text-left">
              {/* Modal Header */}
              <div className="px-6 py-4 border-b border-zinc-150 dark:border-zinc-800 flex items-center justify-between bg-zinc-50/50 dark:bg-zinc-950/30 shrink-0">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-md bg-indigo-600 text-white flex items-center justify-center font-black text-sm shadow-md shadow-indigo-600/20">
                  ...
                  <div>
                    <h3 className="text-base font-black text-zinc-900 dark:text-white flex items-center gap-2">
                      {studentName}
                      {subjectName && (
                        <span className="text-xs font-semibold px-2 py-0.5 rounded-md bg-indigo-50 dark:bg-indigo-950/50 text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-800">
                          {subjectName}
                        </span>
                      )}
                    </h3>
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {/* Average Score Card */}
                      <div className="p-4 rounded-md border border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950/20 space-y-1">
                    ...
                    <form onSubmit={handleSave} className="space-y-5">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {/* Strong Topics */}
                        <div className="p-4 rounded-md border border-emerald-200/60 dark:border-emerald-950/40 bg-emerald-50/30 dark:bg-emerald-950/10 space-y-2">
                          ...
                          {isEditing ? (
                            <input
                              ...
                              className="w-full p-2 text-xs border border-zinc-200 dark:border-zinc-700 rounded-md bg-white dark:bg-zinc-800 text-zinc-800 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-emerald-500 font-medium"
                            />
                          ) : (
                        ...
                        {/* Weak Topics */}
                        <div className="p-4 rounded-md border border-rose-200/60 dark:border-rose-950/40 bg-rose-50/30 dark:bg-rose-950/10 space-y-2">
                          ...
                          {isEditing ? (
                            <input
                              ...
                              placeholder="Nhập các chủ đề phân cách bằng dấu phẩy..."
                              className="w-full p-2 text-xs border border-zinc-200 dark:border-zinc-700 rounded-md bg-white dark:bg-zinc-800 text-zinc-800 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-rose-500 font-medium"
                            />
                          ) : (
                            <div className="flex flex-wrap gap-1.5 pt-1">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {!isEditing && (
                            <button
                              ...
                              className="flex items-center gap-1 text-[11px] font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 px-2 py-1 rounded-md hover:bg-indigo-50 dark:hover:bg-indigo-950/30 transition-colors cursor-pointer"
                            >
                        ...
                        {isEditing ? (
                          <div className="space-y-2">
                            <textarea
                              ...
                              className="w-full p-3 text-xs border border-zinc-200 dark:border-zinc-700 rounded-md bg-white dark:bg-zinc-850 text-zinc-800 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-indigo-500 font-medium leading-relaxed resize-none"
                            />
                          ...
                          <div className="p-4 rounded-md border border-zinc-200 dark:border-zinc-800 bg-zinc-50/60 dark:bg-zinc-950/40 text-xs leading-relaxed text-zinc-700 dark:text-zinc-300 whitespace-pre-wrap font-medium">
                            {data.ai_feedback ? (
                              data.ai_feedback
                            ) : (
                      ...
                      {isEditing && (
                        <div className="flex items-center justify-end gap-2 pt-2 border-t border-zinc-150 dark:border-zinc-800">
                          <button
                            ...
                            className="px-4 py-2 rounded-md text-xs font-bold text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
                          >
                            Hủy
                          </button>
                          <button
                            type="submit"
                            disabled={saving}
                            className="px-4 py-2 rounded-md bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-md shadow-indigo-600/20 flex items-center gap-1.5 transition-colors cursor-pointer disabled:opacity-50"
                          >
                            {saving ? (
