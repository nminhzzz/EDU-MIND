...
export function proxy(request: NextRequest) {
  ...
  // Logout must take precedence over the generic auth-page redirect. This
  // also clears a stale cookie before the browser can be sent to /student.
  if (isAuthPage && request.nextUrl.searchParams.has("logged_out")) {
