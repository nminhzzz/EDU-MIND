...
def test_nvidia_tools():
    ...
    messages = [
        {
            "role": "system",
            "content": "Bạn phải sử dụng tool get_student_analytics_db để tra cứu học lực học sinh trước khi trả lời.",
        },
        {
            "role": "user",
            "content": "Hãy phân tích học lực của học sinh ID=3 môn ID=4 và chào họ.",
        },
    ]
    ...
    try:
        ...
        if msg.tool_calls:
            ...
            print(
                "Iteration 2 response content:", completion2.choices[0].message.content
            )
            print("Success!")
        else:
