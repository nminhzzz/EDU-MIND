...
from app.agents.chat_tutor.intent import detect_intent, extract_subject, extract_target_score, extract_deadline
...
async def test():
    ...
    d = r1["data"]
    print(f"Intent 1: {r1['type']} | subject={d.get('subject')} score={d.get('target_score')} deadline={d.get('deadline')}")
    ...
    sample = UnifiedGoalPlanResponse(
        ...
        daily_schedule=[{"date": "2026-06-24", "start_time": "19:00", "end_time": "21:00", "task": "Hoc chuong 1", "description": "Doc sach"}],
        curriculum_materials=[{"topic": "Chuong 1: Triet hoc", "content": "Noi dung..."}],
        quizzes=[{"title": "Bai kiem tra", "questions": [{"question_text": "Hoi?", "question_type": "true_false", "options": [{"key": "True", "value": "Dung"}, {"key": "False", "value": "Sai"}], "correct_answer": "True", "explanation": "Giai thich", "difficulty": "easy"}]}]
    )
