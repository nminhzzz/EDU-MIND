...
r = client.chat.completions.create(
    model="meta/llama-3.1-70b-instruct",
    messages=[
        {"role": "system", "content": "Ban la gia su toan."},
        {"role": "user", "content": "Lap lo trinh 3 dong."},
    ],
    max_tokens=100,
    timeout=30,
)
...
r = client.chat.completions.create(
    model="meta/llama-3.1-70b-instruct",
    messages=[
        {"role": "system", "content": "Ban la gia su toan. Tra loi JSON."},
        {"role": "user", "content": "Lap lo trinh 3 ngay: ngay,mon,gio"},
    ],
...
r = client.chat.completions.create(
    model="meta/llama-3.1-70b-instruct",
    messages=[{"role": "user", "content": "Tom tat: " + "X" * 3000}],
    max_tokens=50,
    timeout=30,
)
