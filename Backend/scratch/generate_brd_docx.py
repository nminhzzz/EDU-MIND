...
def add_table(headers, rows, col_widths=None):
    ...
    for i, h in enumerate(headers):
        ...
        shading_elm = shading.makeelement(
            qn("w:shd"), {qn("w:fill"): "003366", qn("w:val"): "clear"}
        )
...
add_bullet(
    "MySQL (14 bảng): Lưu trữ các thực thể có cấu trúc chặt chẽ, ràng buộc toàn vẹn dữ liệu cao."
)
add_bullet(
    "MongoDB (3 collections + 1 log): Lưu dữ liệu phi cấu trúc, chat logs, Vector Embeddings RAG."
)
...
add_table(
    ...
    [
        [
            "1",
            "users",
            "Thông tin tài khoản (Học sinh, Giáo viên, Admin) + Enum grade khối lớp",
        ],
        [
            "2",
            "student_preferences",
            "Cấu hình thời gian rảnh & cam kết học tập (1-1 với users)",
        ],
        ...
        [
            ...
            "Đề xuất ôn tập AI đã tự duyệt (HITL Bypass)",
        ],
...
add_table(
    ...
    [
        ...
        [
            ...
            "Vector Store RAG — chunks tài liệu + embedding 4096 chiều",
        ],
...
add_table(
    ...
    [
        [
            ...
            "Học tràn lan, mất phương hướng trước deadline",
        ],
        [
            "P2",
            "Không có ai hỏi đáp ngoài giờ học",
            "Gặp bài khó lúc 22h tối → bỏ qua kiến thức",
        ],
        [
            "P3",
            "Không biết điểm yếu ở đâu",
            "Chỉ biết điểm tổng, không biết hổng chương nào",
        ],
...
add_table(
    ...
    [
        [
            "P5",
            "Soạn đề thi tốn rất nhiều thời gian",
            "Trung bình 2–4 giờ cho 1 bộ đề 30 câu có giải thích",
        ],
        [
            "P6",
            "Chấm bài thủ công, không có phân tích",
            "Chỉ biết điểm tổng, không biết lớp yếu chủ đề nào",
        ],
        [
            "P7",
            "Không thể cá nhân hóa bài tập cho từng HS",
            "1 GV quản lý 100+ HS, không thể giao bài riêng",
        ],
    ],
    col_widths=[1, 7, 10],
)
...
add_table(
    ...
    [
        [
            "P8",
            "Tài liệu phân tán, không có kho tri thức tập trung",
            "HS tự tìm tài liệu ngoài → chất lượng không đảm bảo",
        ],
        [
            "P9",
            "Duyệt thủ công (HITL) làm chậm quá trình ôn tập",
            "GV phải duyệt từng đề xuất AI → HS chờ đợi",
        ],
    ],
    col_widths=[1, 8, 9],
)
...
add_table(
    ...
    [
        [
            "HS tự tìm tài liệu",
            "Thiếu hệ thống RAG",
            "AI trả lời từ kho tài liệu GV (Vector Search)",
        ],
        [
            "GV soạn đề thủ công",
            "Thiếu Quiz Generator AI",
            "AI tự sinh đề thi từ tài liệu RAG",
        ],
        [
            "Chấm bài → chỉ có điểm số",
            "Thiếu Analytics AI",
            "AI phân tích weak/strong topics từng HS",
        ],
        [
            "Muốn ôn tập → chờ GV duyệt",
            "Thiếu Auto-Approve",
            "AI tự duyệt + tạo lịch ôn tập (HITL Bypass)",
        ],
    ],
...
add_table(
    ...
    [
        [
            "OBJ-01",
            "Tăng hiệu quả tự học của Học sinh",
            "Tỷ lệ hoàn thành lộ trình (study_plans done / tổng)",
            "≥ 70%",
        ],
        [
            "OBJ-02",
            "Giảm thời gian soạn đề cho GV",
            "Thời gian từ bấm 'Tạo đề' đến khi có đề hoàn chỉnh",
            "≤ 30 giây",
        ],
        [
            "OBJ-03",
            "Cá nhân hóa ôn tập dựa trên điểm yếu",
            "% HS nhận lịch ôn tập AI bổ sung khi điểm < 8.0",
            "100% (tự động)",
        ],
        [
            "OBJ-04",
            "Loại bỏ nghẽn cổ chai duyệt thủ công",
            "Thời gian từ AI đề xuất → HS nhận lịch ôn tập",
            "≤ 5 giây",
        ],
        [
            "OBJ-05",
            "Cung cấp AI Gia sư 24/7",
            "Tỷ lệ câu hỏi AI trả lời chính xác (dựa trên RAG)",
            "≥ 85%",
        ],
        [
            "OBJ-06",
            "Giúp GV nhận diện lỗ hổng tập thể",
            "% lớp có báo cáo common_weak_topics tự động",
            "100%",
        ],
    ],
...
add_table(
    ...
    [
        [
            "Học sinh (Student)",
            "Người tham gia học tập, làm bài thi tự đánh giá",
            "Student App",
            "Chỉ đọc/ghi dữ liệu CỦA MÌNH",
        ],
        [
            "Giáo viên (Teacher)",
            "Quản lý lớp học, tải tài liệu, theo dõi học lực",
            "Teacher Portal",
            "Đọc/ghi lớp CỦA MÌNH, đọc analytics HS trong lớp",
        ],
        [
            "Quản trị viên (Admin)",
            "Vận hành hệ thống",
            "Admin Portal",
            "Đọc/ghi TOÀN BỘ hệ thống",
        ],
        [
            "AI Agent (Hệ thống)",
            "Tác tử AI tự động hóa nghiệp vụ",
            "Background Tasks",
            "Đọc MySQL + MongoDB, ghi study_plans, quizzes, notifications...",
        ],
    ],
...
add_table(
    ...
    [
        [
            "1",
            "Goal Planner",
            "Lập lộ trình học tập hàng ngày dựa trên mục tiêu + lịch rảnh",
            "study_goals, study_plans, student_preferences",
        ],
        [
            "2",
            "RAG Chat Tutor",
            "Gia sư ảo hỏi đáp bám sát tài liệu (Vector Search + Memory)",
            "chat_sessions, chat_messages, study_material_embeddings",
        ],
        [
            "3",
            "Quiz Generator",
            "Sinh đề thi trắc nghiệm JSON từ tài liệu RAG",
            "quizzes, study_material_embeddings",
        ],
        [
            "4",
            "Recommender",
            "Đề xuất ôn tập thích ứng khi điểm yếu (HITL Bypass)",
            "ai_recommendation_reviews, study_plans, notifications",
        ],
        [
            "5",
            "Cohort Analytics",
            "Phân tích lỗ hổng kiến thức tập thể cả lớp",
            "learning_analytics, classroom_students",
        ],
    ],
...
add_table(
    ...
    [
        [
            ...
            "Quản lý Lớp học",
            "FR-TCH-CLASS-01 → 04",
            "classrooms, subjects, classroom_students",
        ],
        [
            "2",
            "Quản lý Học sinh trong lớp",
            "FR-TCH-STU-01 → 03",
            "classroom_students, users",
        ],
        [
            "3",
            "Quản lý Kho tài liệu RAG",
            "FR-TCH-DOC-01 → 03",
            "study_documents (MySQL), study_material_embeddings (MongoDB)",
        ],
        [
            "4",
            "Dashboard Giám sát Học lực AI",
            "FR-TCH-DASH-01 → 02",
            "learning_analytics, ai_recommendation_reviews",
        ],
    ],
...
add_table(
    ...
    [
        ...
        [
            "7",
            "Lộ trình & Nhiệm vụ hàng ngày",
            "FR-STU-ROAD-01 → 03",
            "study_goals, study_plans, study_plan_progress",
        ],
        [
            "8",
            "Gia sư ảo RAG + Luyện thi AI",
            "FR-STU-CHAT-01, FR-STU-QUIZ-01 → 02",
            "chat_sessions/messages (Mongo), quizzes, quiz_attempts",
        ],
        [
            "9",
            "Thông báo & Ôn tập thích ứng",
            "FR-STU-ALERT-01 → 02",
            "notifications, study_plans, ai_recommendation_reviews",
        ],
    ],
    col_widths=[1, 5, 5, 7],
)
...
add_table(
    ...
    [
        [
            "HITL Bypass",
            "AI tự duyệt đề xuất ôn tập → status = 'approved' → tạo StudyPlan ngày mai + gửi Notification → không cần GV duyệt",
        ],
        [
            "Cross-DB Sync (Xóa tài liệu)",
            "Xóa MySQL study_documents → Xóa Cloudinary file → Xóa MongoDB study_material_embeddings chunks",
        ],
        [
            "Post-Grading Chain",
            "Nộp bài → Chấm điểm → Cập nhật study_plans.status → Cập nhật learning_analytics → Nếu yếu: tạo đề xuất AI + lịch bổ sung",
        ],
    ],
    col_widths=[5, 13],
)
...
add_para(
    "Mô tả: Giáo viên nhập tên lớp, mô tả lớp học và chọn một Môn học (subject_id). "
...
add_bullet(
    "Sinh class_code ngẫu nhiên (8 ký tự, A-Z + 0-9), kiểm tra trùng lặp trong DB."
)
...
add_para(
    "Mô tả: Xem tất cả lớp giáo viên phụ trách, số lượng học sinh mỗi lớp, thông tin môn học. "
...
add_para(
    "Mô tả: Chỉ được cập nhật class_name và description. KHÔNG được đổi subject_id hoặc class_code "
...
add_para(
    "Mô tả: Xóa lớp học. FK ON DELETE CASCADE tự động xóa tất cả classroom_students liên quan."
)
add_note(
    "Hệ quả cascade: Toàn bộ bản ghi classroom_students bị xóa vĩnh viễn. "
...
add_para(
    "Mô tả: Giáo viên thêm học sinh bằng email. Hệ thống tìm ID học sinh trong bảng users "
...
add_para(
    "Mô tả: Hiển thị Họ tên, Email, Ảnh đại diện, Khối lớp (grade), Ngày gia nhập (joined_at)."
)
...
add_para(
    "Endpoint: DELETE /api/v1/classrooms/{classroom_id}/students/{student_id}",
    bold=True,
)
add_para(
    "Mô tả: Trục xuất học sinh khỏi lớp. Xóa bản ghi classroom_students. "
    "KHÔNG xóa tài khoản học sinh, chỉ xóa liên kết lớp."
)
add_para(
    "Lưu ý: Quyền truy cập tài liệu gắn theo subject_id (qua study_goals), "
...
add_para(
    "Mô tả: Giáo viên chọn môn học, nhập tiêu đề, chọn file (PDF/DOCX/TXT/MD). "
    "Backend xử lý đồng bộ với AI Vector Store."
)
add_para("Luồng xử lý Cross-Database:", bold=True)
add_bullet(
    "Bước 1 — Lưu metadata MySQL: Upload file lên Cloudinary → lấy file_path URL → "
    "INSERT INTO study_documents (subject_id, created_by, title, file_path, file_type)."
)
add_bullet(
    "Bước 2 — Background Task Vector hóa: Đọc nội dung file → chia nhỏ thành chunks "
...
add_para(
    "Bảng tương tác: study_documents (MySQL), study_material_embeddings (MongoDB), Cloudinary.",
    italic=True,
)
...
add_para(
    "Mô tả: Bộ lọc theo Môn học. Hiển thị tên file, file_type, ngày tải, link tải gốc."
)
...
add_bullet(
    "Bước 3: DELETE toàn bộ vector chunks trong MongoDB study_material_embeddings "
    "(WHERE metadata.document_id = document_id)."
)
add_bullet("Bước 4: DELETE bản ghi trong MySQL study_documents.")
add_note(
    "Toàn vẹn dữ liệu cross-database: Nếu MongoDB xóa lỗi nhưng MySQL đã xóa → AI có 'dữ liệu rác' "
...
add_para(
    "Mô tả: Xem hồ sơ learning_analytics từng học sinh: điểm trung bình, số đề đã làm, "
...
doc.add_heading(
    "FR-TCH-DASH-02 — Theo dõi đề xuất ôn tập AI + Viết phản hồi (Read + Update)",
    level=4,
)
add_para(
    "Endpoint đọc: GET /api/v1/classrooms/{classroom_id}/recommendations", bold=True
)
add_para("Endpoint ghi: PATCH /api/v1/recommendations/{review_id}/feedback", bold=True)
add_para(
    "Mô tả: Giáo viên xem đề xuất AI đã tự duyệt (status = 'approved'). "
    "Giáo viên có thể viết thêm teacher_feedback để bổ sung bài tập hoặc dặn dò thêm."
)
add_para(
    "Bảng tương tác: ai_recommendation_reviews, users, classroom_students.", italic=True
)
...
add_para(
    "Mô tả: Xem số giờ cam kết học mỗi ngày, buổi học ưu tiên và lịch rảnh chi tiết 7 ngày/tuần."
)
...
add_para(
    "Mô tả: Thay đổi số giờ cam kết, chọn lại buổi ưu tiên (Sáng/Chiều/Tối), bật/tắt khung giờ rảnh. "
...
add_table(
    ...
    [
        ...
        [
            "available_schedule",
            "JSON Object — key phải thuộc {mon, tue, wed, thu, fri, sat, sun}",
        ],
    ],
    col_widths=[6, 12],
)
add_para(
    "Mối liên hệ AI: Goal Planner Agent đọc student_preferences để chỉ phân bổ nhiệm vụ vào khung giờ rảnh.",
    italic=True,
)
add_para("Bảng tương tác: student_preferences.", italic=True)
...
add_para(
    "Mô tả: Học sinh nhập class_code → hệ thống tìm lớp → kiểm tra chưa tham gia → INSERT classroom_students."
)
...
add_para(
    "Mô tả: Xóa classroom_students, giữ nguyên toàn bộ dữ liệu cá nhân (study_goals, quiz_attempts...)."
)
...
doc.add_heading(
    "FR-STU-ROAD-01 — Tạo lộ trình học tập mới (Create) — AI Auto-Scheduling", level=4
)
add_para("Endpoint: POST /api/v1/students/me/study-goals", bold=True)
add_para(
    "Mô tả: Chọn môn, nhập điểm mục tiêu + deadline. AI tự động lập lịch học hàng ngày."
)
add_para("Luồng xử lý:", bold=True)
add_bullet(
    "Bước 1: Validate subject_id + kiểm tra không trùng goal active → INSERT study_goals (status='active')."
)
add_bullet("Bước 2: Đọc student_preferences (lịch rảnh, giờ ưu tiên, số giờ cam kết).")
add_bullet(
    "Bước 3: Gọi Goal Planner Agent → AI sinh mảng nhiệm vụ [{title, description, study_date, start_time, end_time}]."
)
add_bullet(
    "Bước 4: INSERT study_plans (ai_generated=True, status='todo') cho mỗi nhiệm vụ."
)
add_para("Quy tắc validate:", bold=True)
add_table(
    ["Trường", "Quy tắc", "HTTP"],
    [
        ...
        [
            "Không trùng goal active",
            "Kiểm tra study_goals cùng student_id + subject_id + status='active'",
            "409",
        ],
        ["subject_id", "Phải tồn tại trong subjects", "404"],
    ],
...
add_para(
    "Bảng tương tác: study_goals, study_plans, student_preferences, subjects.",
    italic=True,
)

doc.add_heading("FR-STU-ROAD-02 — Cập nhật tiến độ nhiệm vụ ngày (Update)", level=4)
add_para(
    "Endpoint: PATCH /api/v1/students/me/study-plans/{plan_id}/progress", bold=True
)
...
add_table(
    ...
    [
        [
            "A — Tự động (từ bài thi)",
            "quiz_attempts.score ≥ 5.0 (quiz gắn study_plan_id)",
            "study_plans.status → 'done'",
        ],
        [
            "B — Thủ công (đọc tài liệu)",
            "HS cập nhật completion_percent (0–100%)",
            "≥100% → 'done', >0% → 'doing'",
        ],
    ],
    col_widths=[5, 7, 6],
...
add_para(
    "Endpoint hủy: PATCH /api/v1/students/me/study-goals/{goal_id}/drop", bold=True
)
add_para("Endpoint sửa: PUT /api/v1/students/me/study-goals/{goal_id}", bold=True)
add_para(
    "Hủy: Chuyển study_goals.status = 'dropped' + xóa study_plans WHERE status IN ('todo', 'doing')."
)
add_para(
    "Sửa mục tiêu: Cập nhật target_score/deadline → xóa plans chưa xong → AI lập lại lịch mới."
)
...
add_para(
    "Endpoint gửi tin: POST /api/v1/students/me/chat/sessions/{id}/messages (SSE Stream)",
    bold=True,
)
add_para("Luồng RAG:", bold=True)
add_bullet(
    "Bước 1: Lưu tin nhắn user vào MongoDB chat_messages + đọc 20 tin gần nhất (conversation memory)."
)
add_bullet(
    "Bước 2: RAG Vector Search — tìm top 5 chunks liên quan trong study_material_embeddings (cosine similarity)."
)
add_bullet(
    "Bước 3: Xây dựng prompt = System prompt + 5 chunks tài liệu + conversation history + câu hỏi."
)
add_bullet(
    "Bước 4: Gọi OpenAI API (stream=True) → truyền từng token về Frontend qua SSE real-time."
)
add_bullet(
    "Bước 5: Lưu full response vào chat_messages (role: assistant) + ghi ai_logs."
)
...
add_table(
    ...
    [
        [
            ...
            "Phiên < 20 tin nhắn",
            "Lưu nguyên văn 20 tin gần nhất",
        ],
...
add_para(
    "Bảng tương tác: chat_sessions, chat_messages, study_material_embeddings (MongoDB).",
    italic=True,
)
...
add_para(
    "Mô tả: Chọn bài học trong lộ trình → AI sinh đề thi trắc nghiệm JSON bám sát tài liệu RAG. "
    "Đề thi gồm câu hỏi, 4 phương án (A/B/C/D), đáp án đúng, và giải thích chi tiết."
)
add_para(
    "Tham số đầu vào: study_plan_id (bài học trong lộ trình), difficulty (easy/medium/hard), total_questions."
)
add_para(
    "Bảng tương tác: quizzes, study_plans (MySQL), study_material_embeddings (MongoDB).",
    italic=True,
)
...
add_para(
    "Mô tả: Nộp bài → chấm tự động → kích hoạt chuỗi nghiệp vụ hậu chấm thi.", bold=True
)
...
add_table(
    ...
    [
        [
            "1. Chấm điểm",
            "Luôn luôn",
            "So sánh answers với correct_answer JSON → tính score → INSERT quiz_attempts",
        ],
        [
            "2. Cập nhật plan",
            "score ≥ 5.0 AND quiz có study_plan_id",
            "UPDATE study_plans SET status = 'done'",
        ],
        [
            "3. Cập nhật analytics",
            "Luôn luôn",
            "UPDATE learning_analytics (average_score, weak/strong topics, ai_feedback)",
        ],
        [
            "4. HITL Bypass",
            "score < 8.0",
            "INSERT ai_recommendation_reviews (status='approved') + INSERT study_plans ngày mai (19:00–20:00) + INSERT notifications",
        ],
        [
            "5. Adaptive Plan",
            "score < 7.0",
            "AI điều chỉnh lại lộ trình tương lai + gửi notification",
        ],
    ],
    col_widths=[3.5, 4, 10.5],
)
add_note(
    "HITL Bypass: AI tự duyệt đề xuất ôn tập (status = 'approved') và tạo lịch học bổ sung ngày mai "
    "mà không cần giáo viên duyệt thủ công. Đây là cơ chế cốt lõi để loại bỏ nghẽn cổ chai."
)
add_para(
    "Bảng tương tác: quiz_attempts, quizzes, study_plans, learning_analytics, "
    "ai_recommendation_reviews, notifications.",
    italic=True,
)
...
add_para(
    "Mô tả: Nhiệm vụ có prefix [Ôn tập AI] tự xuất hiện ngày mai nếu điểm hôm nay < 8.0. "
...
add_para(
    "Quy tắc: name (2–255 ký tự), code (UNIQUE, A-Z 0-9 underscore), description (tùy chọn, max 5000)."
)
...
add_para(
    "Cho phép đổi name, description. KHÔNG cho phép đổi code sau khi có lớp/tài liệu liên kết."
)

doc.add_heading("FR-ADM-SUB-04 — Xóa môn học (Delete)", level=4)
add_para("Endpoint: DELETE /api/v1/admin/subjects/{id}", bold=True)
add_note(
    "Ràng buộc xóa an toàn: Chỉ xóa khi KHÔNG có bản ghi nào trong classrooms, study_documents, "
...
add_para(
    "Quy tắc: email (UNIQUE), password (≥ 8, có 1 chữ hoa + 1 số), role (Enum), "
    "grade (bắt buộc nếu student, NULL nếu teacher/admin)."
)

doc.add_heading("FR-ADM-USER-02 — Xem danh sách (Read)", level=4)
add_para(
    "Endpoint: GET /api/v1/admin/users?role=student&search=nguyen&is_active=true",
    bold=True,
)
...
add_para(
    "Trường cho phép: full_name, role, grade, is_active (False = khóa), password (reset)."
)
add_note(
    "Khóa tài khoản (is_active = False): JWT hiện tại vẫn hoạt động đến khi hết hạn. "
...
add_note(
    "CASCADE xóa 12 bảng liên quan: student_preferences, classroom_students, classrooms "
...
add_para(
    "Mô tả: Hiển thị agent_name, student_id, input, output, execution_time, created_at. "
...
add_para(
    "Mô tả: Xóa các log đã quá 30 ngày trong MongoDB ai_logs để tiết kiệm dung lượng."
)
...
add_table(
    ...
    [
        [
            "NFR-PERF-01",
            "AI Chat Tutor phản hồi First Token nhanh",
            "≤ 2.5 giây (SSE streaming)",
        ],
        ...
        [
            "NFR-PERF-05",
            "Tránh tràn ID khóa chính",
            "Toàn bộ PK MySQL dùng BIGINT (max 9.2×10¹⁸)",
        ],
    ],
...
add_table(
    ...
    [
        [
            "NFR-SEC-01",
            "JWT Token bảo mật",
            "Lưu Cookie HTTP-Only (chống XSS). Thời hạn 24 giờ",
        ],
        ["NFR-SEC-02", "Mật khẩu mã hóa", "bcrypt hash. Không lưu plaintext"],
        [
            "NFR-SEC-03",
            "Phân quyền API",
            "Middleware kiểm tra role + is_active mỗi request",
        ],
        [
            "NFR-SEC-04",
            "Kiểm tra quyền sở hữu",
            "Teacher chỉ CRUD lớp CỦA MÌNH. Student chỉ truy cập CỦA MÌNH",
        ],
    ],
...
add_table(
    ...
    [
        [
            "NFR-DATA-01",
            "Cross-DB sync khi xóa tài liệu",
            "MySQL DELETE + Cloudinary DELETE + MongoDB deleteMany. Rollback nếu MongoDB fail",
        ],
        [
            "NFR-DATA-02",
            "Liên kết cross-database",
            "Qua student_id/subject_id (Int) — tham chiếu logic, KHÔNG FK vật lý",
        ],
        [
            "NFR-DATA-03",
            "Timestamp UTC",
            "Mọi DATETIME lưu UTC. Frontend chuyển timezone local",
        ],
        [
            "NFR-DATA-04",
            "Enum grade chỉ bắt buộc student",
            "teacher/admin → grade = NULL",
        ],
    ],
    col_widths=[3.5, 5, 9.5],
)
...
add_table(
    ...
    [
        [
            "NFR-AI-01",
            "HITL Bypass mặc định",
            "ai_recommendation_reviews.status = 'approved' tự động",
        ],
        ["NFR-AI-02", "Logging bắt buộc", "Mọi cuộc gọi LLM ghi vào MongoDB ai_logs"],
        [
            "NFR-AI-03",
            "Goal Planner đọc preferences",
            "Không sinh study_plans vào giờ HS không rảnh",
        ],
        [
            "NFR-AI-04",
            "Adaptive threshold",
            "< 8.0 → đề xuất ôn tập. < 7.0 → điều chỉnh lộ trình",
        ],
    ],
...
add_table(
    ...
    [
        [
            ...
            "Docker + docker-compose: FastAPI, Next.js, MySQL, MongoDB, Redis, Nginx",
        ],
        ["NFR-INFRA-02", "Reverse proxy", "Nginx xử lý SSL, routing, static files"],
        [
            "NFR-INFRA-03",
            "File Storage",
            "Cloudinary (production) / Local (dev fallback)",
        ],
    ],
    col_widths=[3.5, 5, 9.5],
)
...
add_table(
    ...
    [
        ...
        [
            "Số phiên chat AI / HS / tuần",
            "COUNT(chat_sessions) GROUP BY student, WEEK",
            "≥ 3 phiên/tuần",
            "chat_sessions (MongoDB)",
        ],
        [
            "Số đề thi đã làm / HS / tuần",
            "COUNT(quiz_attempts) GROUP BY student, WEEK",
            "≥ 2 đề/tuần",
            "quiz_attempts",
        ],
        [
            "Tỷ lệ cập nhật preferences",
            "COUNT(student_preferences) / COUNT(students)",
            "≥ 80%",
            "student_preferences, users",
        ],
    ],
...
add_table(
    ...
    [
        [
            "Thời gian First Token",
            "AVG(execution_time) WHERE agent='RAGTutor'",
            "≤ 2.5 giây",
            "ai_logs (MongoDB)",
        ],
        [
            "Thời gian sinh đề 10 câu",
            "AVG(execution_time) WHERE agent='QuizGenerator'",
            "≤ 30 giây",
            "ai_logs (MongoDB)",
        ],
        [
            "% đề xuất ôn tập được áp dụng",
            "COUNT(status='approved') / COUNT(*)",
            "100%",
            "ai_recommendation_reviews",
        ],
        [
            "Điểm TB sau ôn tập AI",
            "So sánh AVG(score) trước/sau [Ôn tập AI]",
            "Tăng ≥ 1.0 điểm",
            "quiz_attempts, study_plans",
        ],
    ],
    col_widths=[4, 6, 3.5, 4.5],
)
...
add_table(
    ...
    [
        [
            ...
            "95th percentile latency CRUD APIs",
            "≤ 500ms",
            "Application metrics",
        ],
        [
        ...
        [
            ...
            "AVG($vectorSearch execution time)",
            "≤ 800ms",
            "MongoDB profiler",
        ],
    ],
...
add_table(
    ...
    [
        [
            "Thời gian GV soạn đề",
            "Thủ công (2–4h) vs AI (30s)",
            "Giảm 99%",
            "User interview",
        ],
        [
            "% lớp có báo cáo lỗ hổng tập thể",
            "COUNT(lớp có common_weak_topics) / COUNT(lớp)",
            "100%",
            "learning_analytics",
        ],
        [
            "Số tài liệu vector hóa",
            "COUNT(study_material_embeddings)",
            "≥ 1000 chunks/môn",
            "MongoDB",
        ],
        [
            "Tỷ lệ HS cải thiện điểm",
            "COUNT(HS có avg_score tăng sau 30 ngày) / COUNT(HS)",
            "≥ 60%",
            "learning_analytics",
        ],
    ],
