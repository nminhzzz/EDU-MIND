...
async def test():
    ...
    print(
        f"9. MySQL StudyGoal: title='{goal.title}', status={goal.status}, score={goal.target_score}"
    )
    ...
    print(
        f"11. MySQL Quiz: id={quiz.id}, title='{quiz.title}', classroom_id={quiz.classroom_id}"
    )
