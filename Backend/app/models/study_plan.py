import datetime
from sqlalchemy import Column, BigInteger, String, Text, Date, Time, Boolean, Enum, DateTime, ForeignKey
...
class StudyPlan(Base):
    ...
    goal = relationship("StudyGoal", foreign_keys=[goal_id], back_populates="study_plans")
