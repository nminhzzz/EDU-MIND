...
from app.repositories.ai_recommendation_review_repository import ai_recommendation_review_repository
...
def review_recommendation(
    ...
    if status == "approved":
        ...
        if goal:
            ...
            title_text = f"[Ôn tập AI] {review.recommendation[:50]}..." if len(review.recommendation) > 50 else f"[Ôn tập AI] {review.recommendation}"
