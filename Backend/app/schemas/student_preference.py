...
class StudentPreferenceBase(BaseModel):
    study_hours_per_day: int = Field(
        2, ge=1, le=24, description="Số giờ học mong muốn mỗi ngày"
    )
    preferred_study_time: StudyTimeEnum = Field(
        StudyTimeEnum.evening, description="Khung giờ học ưa thích"
    )
