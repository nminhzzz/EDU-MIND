...
from app.schemas.student_preference import StudentPreferenceResponse, StudentPreferenceBase
...
def get_preferences(
    ...
    pref = db.query(StudentPreference).filter(StudentPreference.student_id == current_user.id).first()
    if not pref:
        raise HTTPException(
...
def delete_user_admin(
    ...
    user_service.delete_user_admin(db=db, user_id=user_id, current_admin_id=current_admin.id)
