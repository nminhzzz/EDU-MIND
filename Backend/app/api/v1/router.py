...
api_router.include_router(
    unified_goals_router, prefix="/goals", tags=["🎯 Unified Goal Planner"]
)
...
api_router.include_router(
    documents_router, prefix="/documents", tags=["📂 Document Bank"]
)

api_router.include_router(
    quizzes_router, prefix="/quizzes", tags=["📚 AI Quiz Generator"]
)
...
api_router.include_router(
    classrooms_router, prefix="/classrooms", tags=["🏫 Classrooms"]
)
...
api_router.include_router(
    analytics_router, prefix="/analytics", tags=["📊 System Analytics"]
)
